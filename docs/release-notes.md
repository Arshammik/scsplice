...
**Cross-language parity:** M2 bit-exact vs. R splikit; HVE deviance `rtol=1e-10`; pseudo-correlation `rtol=1e-7`. See [Numerical equivalence](explanation/numerical-equivalence.md) for the full tolerance specification.
